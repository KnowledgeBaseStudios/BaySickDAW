...
> (Task 1's APVTS transaction-semantics spike findings land here FIRST — QA-DirtyFlag reads
> them before its Task 1.)
>
...
*(Seeded at G4 group open 2026-07-25 — no entries yet.)*
