...
- BaySickSolstice, VibePlayer, BaySickSynth, BaySickBass, BaySickVocal, BaySickPedals,
...
- ALL engine-APVTS replaceState call sites switched to the keep-history variant (27
  ...
  paths (Guitars/Basses/Rusty/NAMIR/Pedals/Vocal/Synth/Bass/VibePlayer/BaySickSolstice), the
  4 engine editors' preset loads (BaySickSynthEditor, BaySickBassEditor,
  BaySickSolsticeEditor x2, VibePlayerEditor), the page preset dispatchers (LayersPage x3,
...
- **Files touched:** `Source/BaySickGuitars/BaySickGuitarsProcessor.h`/`.cpp`,
  ...
  `Source/BaySickSolstice/BaySickSolsticeProcessor.cpp`/`BaySickSolsticeEditor.cpp`,
...
LayersPage 3, BaySickSolsticeEditor 3, BaySickAlignEditor 3, PluginProcessor 2
...
- Engine editors: BaySickSolstice auto-gain + Part A/B, NAM-IR six selector
...
- **Files touched:** `Source/Standalone/UndoBracket.h` (new),
  ...
  BaySickRustyDrumsPage), `Source/BaySickSolstice/BaySickSolsticeEditor.cpp`,
...
- **(3a) Preset loads become snapshot ops.**  Vendored:
  ...
  BaySickSolstice x2 incl. "Init Patch", VibePlayer) pass names; load paths and
...
**Bucket:** Cross-cutting Infrastructure, System Pages, UI / L&F / Theming. Batch `long-rewinding-yak`. `blocks:` `5c43cfa0` (the ONE batch commit).
