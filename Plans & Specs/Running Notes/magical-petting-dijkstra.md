...
- **(10)** BaySickSolstice / BaySickSynth / BaySickBass piano keyboards show no amber + no false positives — the closure's `dynamic_cast` fail path correctly returns empty for non-BaySickPlayer engines.
