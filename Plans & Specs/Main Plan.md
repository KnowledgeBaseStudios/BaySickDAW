...
**Bug-fix phases (1-5):**
```
QA-0a* → QA-0 → QA-Inventory*** → QA-Md** → QA-A → QA-C → QA-D → QA-E → QA-Ea********* → QA-Ef************* → QA-Eg*************** → QA-AudioMeters****************** → QA-InsertMaps******************** → QA-VoicePool********************* → QA-SfzGroup*********************** → QA-EngineApvts********************** → QA-Ed************ → QA-Ee************** → QA-Eb********** → QA-Ec*********** → QA-F
...
2026-05-24 at QA-Eg close.  Slotted **immediately after QA-SfzGroup,
before QA-Ed** (per the QA-SfzGroup close-spawned insertion at
QA-VoicePool close 2026-05-26; was "after QA-VoicePool" pre-QA-SfzGroup
insertion; Jeff's confirmed slot per
