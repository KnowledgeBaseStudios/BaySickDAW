...
- [HarmlessProcessor.cpp:76](Source/Harmless/HarmlessProcessor.cpp:76) + [VibePlayerProcessor.cpp:38](Source/VibePlayer/VibePlayerProcessor.cpp:38) — gate `updateFromApvts()` behind `if (mDirtyTracker.hasChangedSinceLastBlock())`.
