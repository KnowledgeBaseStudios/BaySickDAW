...
- [ ] L13: PageMenuBar extended with a second titled menu entry; "Add" menu = Aux Strip, Vox Bus, Inst Bus, Layers Bus, Bass Bus, Clips Bus, Plugins Bus; the five title-strip buttons removed.
