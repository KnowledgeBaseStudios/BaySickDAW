...
//   LFO accent    : #00CED1  (soft cyan)
//   Inactive      : #2A2C30      Typography     : #E0E0E0
//
// Highlights:
//   - Rotary: thin dark track, green arc with triple-layer bloom, hex-bolt base,
//     pointer tick, bipolar origin at 12 o'clock for signed ranges
//   - Buttons: dark rect, green fill when toggled/active
//   - Labels: small, white, centred
// ─────────────────────────────────────────────────────────────────────────────
class BaySickSynthLAF : public juce::LookAndFeel_V4
{
public:
    static constexpr uint32_t kGreen    = 0xFFA0DB2B;
    static constexpr uint32_t kCyan     = 0xFF00CED1;
    ...
    BaySickSynthLAF()
    {
        ...
        setColour (juce::PopupMenu::highlightedBackgroundColourId,   juce::Colour (0xFF2A3A10));
                                ...
                                bool highlighted, bool down) override
    {
        ...
        {
            // VEL-style flat toggle: dark fill always, LED bar on top when on.
        ...
        g.setColour (juce::Colour (on ? 0xFF6AAA20u : 0xFF3A3C40u));
                          ...
                          bool /*highlighted*/, bool /*down*/) override
    {
        ...
        if (btn.getClickingTogglesState())
        {
            // VEL-style: green when on, grey when off.
        ...
        // Push-button text (tabs etc.)
        g.setColour (on ? juce::Colour (0xFF0A0B0C) : juce::Colour (kText));
    ...
    {
        const int maxTextW = 420;   // wider than JUCE default (~150)
