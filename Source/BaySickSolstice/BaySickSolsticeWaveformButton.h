...
class BaySickSolsticeWaveformButton : public juce::Component
{
public:
    std::function<void(int)> onChange;  // called with new shape index

    BaySickSolsticeWaveformButton() = default;
...
private:
    int mShape { 0 };
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BaySickSolsticeWaveformButton)
};
