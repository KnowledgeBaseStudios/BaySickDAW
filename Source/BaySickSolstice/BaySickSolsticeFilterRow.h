...
// The parent BaySickSolsticeEditor creates two of these (one per filter).
class BaySickSolsticeFilterRow : public juce::Component
{
public:
    BaySickSolsticeFilterRow();
    ~BaySickSolsticeFilterRow() override;

    // Must be called before adding to parent. prefix = e.g. "tk_0_bso_flt1_"
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BaySickSolsticeFilterRow)
};
