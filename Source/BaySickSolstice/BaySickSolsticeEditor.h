...
// ─────────────────────────────────────────────────────────────────────────────
class BaySickSolsticeEditor : public juce::AudioProcessorEditor,
                       private juce::ValueTree::Listener
{
public:
    explicit BaySickSolsticeEditor (BaySickSolsticeProcessor& p);
    ~BaySickSolsticeEditor() override;
    ...
    static juce::String getEngineTitle()  { return "BaySickSolstice"; }
    static juce::Colour getEngineAccent() { return juce::Colour (BaySickSolsticeLAF::kAccent); }
...
private:
    ...
    // ── Look and Feel ─────────────────────────────────────────────────────────
    BaySickSolsticeLAF mLAF;

    // ── Header ────────────────────────────────────────────────────────────────
    // Accent = BaySickSolsticeLAF::kAccent (#FF6600 orange).  The preset button
    ...
    BaySickSolsticeWaveformButton mTimbreWavA;   // Part A shape display/selector
    BaySickSolsticeWaveformButton mTimbreWavB;   // Part B shape display (display only)
    BaySickSolsticeWaveformButton mTremWavBtn;   // Tremolo waveform selector
    BaySickSolsticeWaveformButton mVibWavBtn;    // Vibrato waveform selector

    // ── Specialized panel components ──────────────────────────────────────────
    BaySickSolsticeFilterRow     mFilter1Row;
    BaySickSolsticeFilterRow     mFilter2Row;
    BaySickSolsticeRoutingMatrix mRoutingMatrix;
    BaySickSolsticeXYZPad        mXYZPad;
    BaySickSolsticeModEditor     mModEditor;
    ...
    // ── Top-Right Panel: filters done via BaySickSolsticeFilterRow components above
    // Bottom FX row
    ...
    // BaySickSolsticeModRegistry (owned by the processor) and the mod editor pulls
    // from it directly.

    BaySickSolsticeProcessor& mProc;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BaySickSolsticeEditor)
};
