...
BaySickSolsticeXYZPad::BaySickSolsticeXYZPad()
{
...
void BaySickSolsticeXYZPad::sliderValueChanged (juce::Slider* s)
{
...
void BaySickSolsticeXYZPad::attachToApvts (juce::AudioProcessorValueTreeState& apvts,
                                     ...
                                     const juce::String& zId)
{
    ...
    auto wire = [&apvts] (const juce::String& id, BaySickSlider& knob,
...
void BaySickSolsticeXYZPad::paint (juce::Graphics& g)
{
    // Pad background
...
void BaySickSolsticeXYZPad::resized()
{
...
void BaySickSolsticeXYZPad::mouseDown (const juce::MouseEvent& e) { updateFromMouse (e); }
void BaySickSolsticeXYZPad::mouseDrag (const juce::MouseEvent& e) { updateFromMouse (e); }

void BaySickSolsticeXYZPad::updateFromMouse (const juce::MouseEvent& e)
{
