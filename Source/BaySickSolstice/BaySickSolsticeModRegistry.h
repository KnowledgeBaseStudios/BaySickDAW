...
#include <memory>
#include <vector>
#include "BaySickSolsticeModEditor.h"   // for BaySickSolsticeCurvePoint

// ── BaySickSolsticeModRegistry ───────────────────────────────────────────────────────
// Per-target modulation registry for BaySickSolstice. Implements the S4 mod matrix:
...
//   registration sequence in BaySickSolsticeProcessor::registerModTargets.
//
// Thread model:
...
// Target index = registration order in BaySickSolsticeProcessor::registerModTargets.
...
//   SynthLevel   : output-phaser params live post-voice in BaySickSolsticeSynth; the
...
namespace BaySickSolsticeModLength
{
