...
class BaySickSolsticeXYZPad : public juce::Component,
...
private:
    ...
    BaySickSlider mXKnob, mYKnob, mZKnob;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BaySickSolsticeXYZPad)
};
